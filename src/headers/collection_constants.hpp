...
static vector<string_view> FLOW_FLAGS {
    FILE_PROCESSING,
    DATA_PROCESSING
};

static vector<string_view> BRANCH_FLAGS {
	COMPARE_PROCESSING,
	CROP_PROCESSING,
	CONVERT_PROCESSING,
	DETECT_PROCESSING,
...
static vector<string_view> RESOURCE_FLAGS {
	IMAGE_PROCESSING,
	VIDEO_PROCESSING
};

static vector<string_view> TYPE_FLAGS {
	CREATION_TIME_FLAG,
	LAST_MODIFIED_TIME_FLAG,
	LAST_ACCESS_TIME_FLAG
};

static vector<string_view> HELP_FLAGS {
	FULL_HELP_FLAG,
	HYPHEN_HELP_FLAG,
	HYPHEN_FULL_HELP_FLAG
};

static map<string_view, vector<string_view>> PROCESSING_SUPPORT {
